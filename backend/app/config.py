...
class Settings(BaseSettings):
    ...
    RECORDING_SERVICE_TOKEN: str = os.getenv("RECORDING_SERVICE_TOKEN", os.getenv("INTERNAL_SERVICE_TOKEN", ""))
    RECORDING_BASE_URL: str = os.getenv("RECORDING_BASE_URL", "https://interview.pontis.one")
