...
export default function InterviewRecordingPlayer({
  ...
  return (
    <div className={cn('interview-recording-player-shell relative h-full min-h-[500px] w-full overflow-hidden rounded-[1.5rem] border border-slate-800/80 bg-black', className)}>
